...
public class AnimationSystem : SingletonMonoBehaviourFast<AnimationSystem>
{
    ...
    public Sprite[] CharaEmo0 = new Sprite[0];
    public Sprite[] CharaEmo1 = new Sprite[0];
    public Sprite[] CharaEmo2 = new Sprite[0];
    private Sprite[,] Character_emotion = new Sprite[3, 5];
    ...
    void Start()
    {
        ...
        for (int i = 0; i < CharaEmo0.Length; i++) Character_emotion[0, i] = CharaEmo0[i];
        ...
        for (int i = 0; i < CharaDATA.Character.Length; i++)
        {
            ...
            if ((int)CS.Position != 3)
            {
                ...
                if (Character_Object[(int)CS.Character].color.a == 0)
                {
                    ...
                    Character_Object[(int)CS.Character].GetComponent<RectTransform>().DOAnchorPosY(0, 1.5f);
            ...
            else//フェードアウトであれば、特殊な操作を入れる
            {
                ...
                Character_Object[(int)CS.Character].GetComponent<RectTransform>().DOAnchorPosY(-100, 1.5f);
            }
